...
// Use &&, ||, and !
let isNiceNumber = (a % 2 === 0 && b % 2 != 0) || c != 0;
...
let settings = {};
Object.assign(settings,overrides,defaults);
...
console.log(displayName.charAt(0).toLowerCase() + displayName.slice(1).toUpperCase());
console.log(displayName.charAt(0).toUpperCase() + displayName.slice(1).toLowerCase());
console.log(displayName.replace(displayName[0], displayName[0].toUpperCase()));
